...
-(void)setTitleTrans
{
    self.thumb.label.numberOfLines=0;
    self.thumb.secondLabel.numberOfLines=0;
    
    self.thumb.label.transform=CGAffineTransformMakeRotation(-M_PI/2);
    self.thumb.secondLabel.transform=CGAffineTransformMakeRotation(-M_PI/2);
}
