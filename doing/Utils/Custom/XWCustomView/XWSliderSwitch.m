...
#define kLabelOffset 58
#define kLabelWidth  60
#define kLabelHeight 29

@implementation XWSliderSwitch
...
-(void)setLabelOneColor
{
    _labelOne.textColor=[UIColor whiteColor];
    _labelTwo.textColor=[UIColor purpleColor];
    
    
}

-(void)setLabelTwoColor
{
    _labelOne.textColor=[UIColor purpleColor];
...
- (void)setToggleButtonImage
{
    ...
    UIImage *image = [UIImage imageNamed:@"square_top_button_selected.png"];
...
//button has been finished dragging
