...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        self.circleFillColour = [UIColor colorWithWhite:1.0 alpha:0.0];
        self.circleFillColor2=[UIColor redColor];
        self.circleFillColourHighlighted = [UIColor whiteColor];
        self.pathColour = [UIColor colorWithWhite:1.0 alpha:0.3];
