...
@property (weak,nonatomic) UIImageView      *imageDelete;
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        self.imageDelete.hidden= self.deleleBtn.hidden;
    }
...
- (UIButton *)deleleBtn{
    if (!_deleleBtn) {
        ...
        //deleleBtn.backgroundColor=[UIColor redColor];
...
#pragma mark deleleImage
- (UIImageView *)imageDelete{
    if (!_imageDelete) {
        UIImageView *deleleBtn = [[UIImageView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-18-15, 15, 18, 18)];
        deleleBtn.image=[UIImage imageNamed:@"nav_delete_btn"];
        
        [self.view addSubview:deleleBtn];
        self.imageDelete = deleleBtn;
