...
- (void)initNaviBar{
    ...
    //[backItem setImage:[UIImage imageNamed:@"guo_arrow_left_gray.png"] forState:UIControlStateNormal];
    ...
    UIImageView *backImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 15, 9, 14)];
    backImageView.image = [UIImage imageNamed:@"guo_arrow_left_gray.png"];
    [backView addSubview:backImageView];
    [backView addSubview:backItem];
    
    UIButton * closeItem = [[UIButton alloc]initWithFrame:CGRectMake(44+12, 0, 44, 44)];
    [closeItem setTitle:@"close" forState:UIControlStateNormal];
