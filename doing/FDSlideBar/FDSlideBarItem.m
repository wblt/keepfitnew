...
#define DEFAULT_TITLE_SELECTED_COLOR [UIColor blackColor]
...
+ (CGFloat)widthForTitle:(NSString *)title {
    ...
    */
    CGSize result = [title sizeWithFont:[UIFont systemFontOfSize:DEFAULT_TITLE_FONTSIZE] constrainedToSize:CGSizeMake(HUGE, HUGE) lineBreakMode:NSLineBreakByWordWrapping];
    result.width = ceil(result.width) + HORIZONTAL_MARGIN * 2;
    return result.width;
}
